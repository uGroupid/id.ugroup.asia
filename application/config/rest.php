...
$config['rest_mongodb_group']  = 'ureg_cpanel';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_keys_table'] = 'ureg_api_keys';
$config['rest_keys_collection'] = 'ureg_api_keys';
...
|
*/
$config['rest_logs_table'] = 'ureg_api_logs';
$config['rest_logs_collection'] = 'ureg_api_logs';
...
|
*/
$config['rest_limits_table'] = 'ureg_api_limits';
$config['rest_limits_collection'] = 'ureg_api_limits';
